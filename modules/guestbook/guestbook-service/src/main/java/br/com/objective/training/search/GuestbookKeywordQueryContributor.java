...
public class GuestbookKeywordQueryContributor implements KeywordQueryContributor {
    ...
    public void contribute(String keywords, BooleanQuery booleanQuery, KeywordQueryContributorHelper keywordQueryContributorHelper) {
        ...
        queryHelper.addSearchLocalizedTerm(booleanQuery, searchContext, Field.DESCRIPTION, true);
        queryHelper.addSearchLocalizedTerm(booleanQuery, searchContext, Field.NAME, true);
        queryHelper.addSearchLocalizedTerm(booleanQuery, searchContext, GuestbookField.RESOURCE_NAME, true);
    }
